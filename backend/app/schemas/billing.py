...
class CreateCheckoutSessionRequest(BaseModel):
    ...
    price_id: str = Field(..., description="Stripe price ID (Chef's Choice or Master Chef tier)")
...
class TierInfo(BaseModel):
    """Tier information for pricing."""
    id: str
    name: str
    display_name: str
    price_monthly: float
    stripe_price_id: Optional[str] = None
    action: str  # 'upgrade', 'downgrade', or 'current'
...
class SubscriptionStatusResponse(BaseModel):
    ...
    available_tiers: List[TierInfo] = Field(..., description="List of available tiers to upgrade/downgrade to")


class TierDetail(BaseModel):
    """Tier details for pricing page."""
    id: UUID
    name: str
    display_name: str
